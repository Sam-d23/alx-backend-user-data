...
def register_user(email: str, password: str) -> None:
    """
    Testing user registration using the given email and password.
    Args:
...
def log_in_wrong_password(email: str, password: str) -> None:
    """
    Testing log in using the given wrong credentials.
    Args:
        email: The email of the user.
        password: The password of the user.
    Returns:
...
def profile_unlogged() -> None:
    """
    Testing for profile without being logged in with session_id.
    Returns:
        None
    """
...
def log_in(email: str, password: str) -> str:
    """
    Testing log in using the given correct email and password.
    Args:
        email: The email of the user.
        password: The password of the user.
    Returns:
...
def profile_logged(session_id: str) -> None:
    """
    Testing profile while being logged in with session_id.
    Args:
...
def log_out(session_id: str) -> None:
    """
    Testing log out using the given session_id.
    Args:
        session_id: The user's session_id.
    Returns:
        None
...
def reset_password_token(email: str) -> str:
    """
    Testing reset password token using the given email.
    Args:
...
def update_password(email: str, reset_token: str,
    ...
    """
    Testing update password using the given email,
